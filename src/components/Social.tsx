    ...
    return (
        <section id='social'>
            <ul className='ml-1 mt-8 flex items-center gap-4'>
                <li>
                    <a target='_blank' href="https://github.com/muraddagha" className='block hover:text-slate-200'>
                ...
                <li>
                    <a target='_blank' href="https://linkedin.com/in/murad-aghakishiyev-3b30a0210" className='block hover:text-slate-200'>
